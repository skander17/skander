                ...
                <form action="compras" method="POST">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" placeholder="Correo Electronico" id="email" name="email" class="form-control" value=<?= $moneda->email ?>>
                        </div>
                    </div>
                    <?php if ($action == 'crear'): ?>
                        <div class="form-group">
                ...
                <table class="tabla mb-5">
                    ...
                    <?php foreach($monedas as $key => $moneda):?>
                        <tr>
                            ...
                            <td><a href="compras?action=editar&id=<?= $moneda['id']?>" class="btn btn-warning"> <i class="fas fa-edit"></i></a></td>
                            <td>
                                <form action="compras" method="POST">
